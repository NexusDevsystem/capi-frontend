        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-10 max-w-[1400px] w-full mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {serviceOrders.map(os => (
                    <div key={os.id} className={`bg-white dark:bg-card-dark rounded-xl border-l-[6px] border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all cursor-pointer group animate-fade-in-up border-l-slate-400`}>
                        <div className="p-5"> {/* Added p-5 back as it was removed by the change */}
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                    <div className="bg-white dark:bg-card-dark rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm w-full max-w-2xl p-6 max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="flex justify-between items-center pt-4 border-t dark:border-slate-700">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button onClick={handleSave} className="px-6 py-2 bg-primary text-white rounded-lg font-bold hover:bg-primary-dark shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all">Salvar OS</button>
                            </div>
                        </div>
                    </div>
                </div>
