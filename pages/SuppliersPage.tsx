    ...
    return (
        <div className="flex-1 overflow-y-auto p-6 md:p-10 max-w-[1200px] w-full mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                ...
                <button
                    onClick={() => { setEditingId(null); setFormData({ name: '', contactName: '', phone: '', email: '', category: '' }); setIsModalOpen(true); }}
                    className="flex items-center gap-2 bg-slate-900 text-white px-4 py-2 rounded-lg hover:bg-slate-800 transition-all hover:scale-105 shadow-lg hover:shadow-xl"
                >
                ...
                {suppliers.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                        {suppliers.map(supplier => (
                            <div key={supplier.id} className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-5 border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all group relative">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm px-4">
                    <div className="bg-white dark:bg-card-dark p-6 rounded-xl w-full max-w-lg shadow-2xl border border-slate-200 dark:border-slate-700 animate-zoom-in">
                        ...
                        <div className="flex justify-end gap-2 mt-6">
                            ...
                            <button type="submit" onClick={handleSubmit} className="px-6 py-2 bg-slate-900 text-white rounded-lg hover:bg-slate-800 font-bold shadow-lg hover:shadow-xl transition-all">
                                Salvar
                            </button>
                        </div>
                    </div>
