    ...
    return (
        <div className="flex-1 overflow-y-auto p-6 md:p-10 max-w-[1200px] w-full mx-auto pb-32">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    <div className="flex items-center gap-3">
                        ...
                        <button onClick={togglePrivacy} className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors mt-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 animate-fade-in-up">
                ...
                <div className="bg-white dark:bg-card-dark p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden group hover:border-blue-300 transition-colors">
                    ...
                    <div>
                        ...
                        <h3 className="text-2xl font-black text-slate-900 dark:text-white">
                            {privacyMode ? <span className="blur-sm opacity-50">R$ •••••</span> : formatCurrency(stockMetrics.totalCost)}
                        </h3>
                ...
                <div className="bg-white dark:bg-card-dark p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden group hover:border-emerald-300 transition-colors">
                    <div className="absolute -right-4 -bottom-4 opacity-10 group-hover:opacity-20 transition-opacity">
                    ...
                    <div>
                        ...
                        <h3 className="text-2xl font-black text-emerald-600 dark:text-emerald-400">
                            {privacyMode ? <span className="blur-sm opacity-50">R$ •••••</span> : formatCurrency(stockMetrics.totalSale)}
                        </h3>
                ...
                <div className="bg-gradient-to-br from-primary to-orange-700 text-white p-6 rounded-2xl shadow-lg shadow-orange-500/20 relative overflow-hidden group">
                    ...
                    <div>
                        ...
                        <h3 className="text-2xl font-black text-white">
                            {privacyMode ? <span className="blur-sm opacity-50">R$ •••••</span> : formatCurrency(stockMetrics.projectedProfit)}
                        </h3>
            ...
            {isImportReviewOpen && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-fade-in">
                    <div className="bg-white dark:bg-card-dark rounded-xl w-full max-w-5xl shadow-2xl flex flex-col max-h-[90vh]">
